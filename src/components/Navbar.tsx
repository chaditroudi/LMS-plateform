      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/admin" className="text-gray-600 hover:text-purple-600 transition-colors">Admin</Link>
          </div>

          <div className="hidden md:flex items-center space-x-4">
            <Link href="/profile" className="text-gray-600 hover:text-purple-600 transition-colors px-2 py-2">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-3 border-t border-gray-100">
            ...
            <Link href="/admin" className="block text-gray-600 hover:text-purple-600 py-2">Admin</Link>
            <Link href="/profile" className="block text-gray-600 hover:text-purple-600 py-2">Profile</Link>
